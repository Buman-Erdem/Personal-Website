...
const LINKS = {
  animoods: `https://github.com/${GITHUB_HANDLE}/animoods`,
  reviewer: `https://github.com/${GITHUB_HANDLE}/resume-reviewer`,
  cacheviz: `https://github.com/${GITHUB_HANDLE}/cacheviz`,
  issuesync: `https://github.com/${GITHUB_HANDLE}/issuesync-lab`,
  memorysprint: `https://github.com/${GITHUB_HANDLE}/memorysprint`,
}
...
const PROJECTS = [
  {
    title: "AniMoods",
    desc:
      "Mood‑based anime & movie recommender using client‑side cosine similarity over curated embeddings; optional Supabase auth.",
  ...
  },
  {
    ...
    desc:
      "Local, rule‑based scoring (impact metrics, action verbs, ATS keywords) with optional BYO‑API LLM toggle.",
    tags: ["Next.js", "pdf.js"],
    link: LINKS.reviewer,
  },
  {
    title: "CacheViz",
    desc:
      "Interactive set‑associative cache simulator with LRU; visualizes hit/miss patterns and AMAT for uploaded traces.",
    tags: ["React", "D3"],
    link: LINKS.cacheviz,
  },
  {
    title: "IssueSync Lab",
    desc:
      "Mock Jira ↔ HSD sync demo inspired by enterprise workflows. Mapping rules, idempotent upserts, and audit logs.",
    tags: ["Node", "Express"],
    link: LINKS.issuesync,
  },
  {
    title: "MemorySprint",
    desc:
      "Memory‑sports trainer (numbers/faces/decks) as an installable PWA with offline storage via IndexedDB.",
    tags: ["React", "PWA"],
    link: LINKS.memorysprint,
  },
]
